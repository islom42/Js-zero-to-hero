...
2-) writeGenres nomli funksiya yozing ushbu funksiya 3marta foydalanuvchidan “Yaxshi ko’rgan janringiz ${son ketma ketlikda}”. Hamma javobni genres massivga joylang.
...
const showDb = () => seriesDB.private === false ? console.log(seriesDB) : null;
const writeGenres = () => {
	for (let index = 0; index < 3; index++) {
		let genres = prompt(`Yaxshi ko’rgan janringiz`)
